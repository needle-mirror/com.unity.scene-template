...
namespace UnityEditor.SceneTemplate
{
    ...
    public class SceneTemplateProjectSettings
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent browseTypeContent = new GUIContent("Browse type...");
            public static float scrollViewHeight = 300;
        ...
        private static void InitDefaultDependencyTypeInfos()
        {
            ...
            defaultDependencyTypeInfos.Add(new DependencyTypeInfo(typeof(UnityEditor.Animations.AnimatorController))
            {
                defaultInstantiationMode = TemplateInstantiationMode.Clone,
            });
            defaultDependencyTypeInfos.Add(new DependencyTypeInfo(typeof(AnimatorOverrideController))
            {
                defaultInstantiationMode = TemplateInstantiationMode.Clone,
            });
            defaultDependencyTypeInfos.Add(new DependencyTypeInfo(typeof(PhysicMaterial))
            {
                defaultInstantiationMode = TemplateInstantiationMode.Clone,
            });
            defaultDependencyTypeInfos.Add(new DependencyTypeInfo(typeof(UnityEngine.PhysicsMaterial2D))
            {
                defaultInstantiationMode = TemplateInstantiationMode.Clone,
            });
